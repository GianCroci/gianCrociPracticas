...
public class SegundoParcial {
	...
	public void queSePuedaEmitirUnaPolizaDeVida() {
		...
		assertEquals(2, poliza.obtenerCantidadDeBeneficiario());
		assertEquals(asegurado, poliza.getAsegurado());
		assertEquals(PREMIO, poliza.getPremio());
	}
	...
	public void queSePuedaEmitirUnaPolizaDeCombinadoFamiliar() {
		...
		Integer beneficiariosEsperados = 3;
	
		assertEquals(beneficiariosEsperados, poliza.obtenerCantidadDeBeneficiario());
		assertEquals(asegurado, poliza.getAsegurado());
		assertEquals(PREMIO, poliza.getPremio());
	}
	...
	public void queSePuedanAdministrarDistintosTiposDePolizas() {
		...
		libra.agregarPoliza(new PolizaDeAuto(5, new Persona("Victor", 652354, 24), 2000000.0, 5000.0));
	...
	@Test
	public void queSePuedaDenunciarElRoboDeUnAuto() throws Exception {
		Integer numeroDePoliza = 1;
		CompaniaDeSeguro libra = new CompaniaDeSeguro("Libra");
	...
	@Test
	public void queSePuedaDenunciarUnSiniestroParaUnaPolizaDeVida() throws Exception {
		Integer numeroDePoliza = 1;
		CompaniaDeSeguro libra = new CompaniaDeSeguro("Libra");
